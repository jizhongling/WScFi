...
G4VPhysicalVolume* B4cDetectorConstruction::DefineVolumes()
{
  ...
  G4Material* EMCal_abs_mat=new G4Material("EMCal_fiber_mat", 12.72*g/cm3,2);
  EMCal_abs_mat->AddElement(elW, 97.0*perCent);
  EMCal_abs_mat->AddMaterial(gapMaterial2, 3.0*perCent);
