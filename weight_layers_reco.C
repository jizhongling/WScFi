...
const float w0 = 0.6; // initial weight for ecal
const float wopt =1; // optimal weight for ecal after first pass

double filename[6] ={0.5,1,2,5,10,20};
const char *energylevel[9] = {"MeV","MeV","MeV", "GeV", "GeV", "GeV", "GeV", "GeV", "GeV"};
double minenergy[7]= {0.5,0.5,0.5,0.5,0.5,0.5,0.5};//{80.5,160.5,400.5,800.5,1600.5, 4000.5, 8000.5, 16000.5, 30000.5};
double maxenergy[7]= {50.5,100.5,200.5,500.5,1000.5, 2000.5, 4000.5};

float energyname[7]= {0.5,1,2,5,10,20,40};
...
int cen = 5;
	...
	char fname_log[200];
	sprintf(fname_log,"20mm-mixture-52layer-electron/20.log");
    ...
    //works up to here
 	...
 	char fname_out[200];
	sprintf(fname_out,"energy%3.1f_electron.mixture.reco.root", energyname[cen]);
